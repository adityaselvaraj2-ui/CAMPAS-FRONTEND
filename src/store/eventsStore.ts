...
const INITIAL_EVENTS: CampusEvent[] = [
  ...
  // KPR
  { id:'e19', title:"KPR Tech Fest — PRADHYUMNA 2025", date:"2025-03-18", time:"09:00", venue:"Imperial Hall", college:"KPR", category:"Technical", capacity:500, registered:387, addedByAdmin:false },
  { id:'e20', title:"Placement Drive — Wipro", date:"2025-03-12", time:"09:00", venue:"T&P Block", college:"KPR", category:"Placement", capacity:300, registered:275, addedByAdmin:false },
  { id:'e21', title:"KPR Cultural Night — THANDORA", date:"2025-04-08", time:"17:00", venue:"Open Theatre", college:"KPR", category:"Cultural", capacity:800, registered:654, addedByAdmin:false },
  { id:'e22', title:"Workshop: IoT & Embedded Systems", date:"2025-03-22", time:"10:00", venue:"ECE Block", college:"KPR", category:"Technical", capacity:60, registered:52, addedByAdmin:false },
  { id:'e23', title:"KPR End Semester Exams", date:"2025-04-25", time:"09:00", venue:"Exam Cell", college:"KPR", category:"Exam", capacity:1800, registered:1650, addedByAdmin:false },
  { id:'e24', title:"Inter-College Cricket Tournament", date:"2025-03-30", time:"08:00", venue:"Cricket Ground", college:"KPR", category:"Sports", capacity:500, registered:380, addedByAdmin:false },
];
