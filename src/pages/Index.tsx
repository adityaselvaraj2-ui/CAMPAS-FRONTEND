...
const Index = () => {
  ...
  const campusForContext = selectedCampus?.id === 'sjce' ? 'SJCE' : selectedCampus?.id === 'sjit' ? 'SJIT' : selectedCampus?.id === 'cit' ? 'CIT' : selectedCampus?.id === 'kpr' ? 'KPR' : null;

  const handleSelectCampus = useCallback((campusId: string) => {
    setSelectedCampusId(campusId);
    setActiveTab('navigate');
    const mapped = campusId === 'sjce' ? 'SJCE' : campusId === 'sjit' ? 'SJIT' : campusId === 'cit' ? 'CIT' : campusId === 'kpr' ? 'KPR' : null;
